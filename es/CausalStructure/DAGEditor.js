...
export var DAGEditor = function DAGEditor(_ref) {
  ...
  var legendText = svg.select("#legend").selectAll(".legendText").data(["treatment", "outcome", "confounds", "colliders", "mediators"]).join("text").attr("class", "legendText").attr("x", layout.width - layout.margin * 2 + 18).attr("y", function (d, i) {
  ...
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(Menu, {
  ...
  }, "Delete from Graph")), /*#__PURE__*/React.createElement(IconButton, {
    id: "fitScreen",
    ...
    style: aStyle,
    title: "reset zoom"
  }, /*#__PURE__*/React.createElement(FullscreenExitOutlinedIcon, null))), /*#__PURE__*/React.createElement("svg", {
    width: layout.width,
