...
export var CompareDistributionVis = function CompareDistributionVis(_ref) {
  ...
  var _React$useState9 = React.useState({
    ...
    setColorMap = _React$useState9[1];
  ...
  useEffect(function () {
    ...
    var endPoint = [d3.max(unadjustedAttribute), 0];
    ...
    var unadjustedTLine = getLine(thresholds, unadjustedTreatmentData, startPoint, endPoint, newXScale, newYScaleTreatment);
