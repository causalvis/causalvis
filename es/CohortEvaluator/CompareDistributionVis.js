...
export var CompareDistributionVis = function CompareDistributionVis(_ref) {
  ...
  var _React$useState6 = React.useState(false),
      ...
      setIconShow = _React$useState6[1]; // const [selectedBins, setSelectedBins] = React.useState([]);
  ...
  useEffect(function () {
    ...
    var unadjustedCMean = d3.mean(unadjustedControlData);
    var unadjustedTMean = d3.mean(unadjustedTreatmentData);
    var adjustedCLine;
    var adjustedTLine;
    var adjustedCMean;
    ...
    svgElement.select("#unadjusted").selectAll(".unadjustedCLine").data([unadjustedCLine]).join("path").attr("class", "unadjustedCLine").attr("fill", "none").attr("stroke", "#000").attr("stroke-width", 1).attr("stroke-linejoin", "round").attr("d", function (d) {
      return d;
    });
    svgElement.select("#adjusted").selectAll(".adjustedCLine").data([adjustedCLine]).join("path").attr("class", "adjustedCLine").attr("fill", colorMap.control).attr("stroke", "none").attr("d", function (d) {
      return d;
    });
    svgElement.select("#unadjusted").selectAll(".unadjustedTLine").data([unadjustedTLine]).join("path").attr("class", "unadjustedTLine").attr("fill", "none").attr("stroke", "#000").attr("stroke-width", 1).attr("stroke-linejoin", "round").attr("d", function (d) {
      return d;
    });
    svgElement.select("#adjusted").selectAll(".adjustedTLine").data([adjustedTLine]).join("path").attr("class", "adjustedTLine").attr("fill", colorMap.treatment).attr("stroke", "none").attr("d", function (d) {
      return d;
    });
    /*
     *
