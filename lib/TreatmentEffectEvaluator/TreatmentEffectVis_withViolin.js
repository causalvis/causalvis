...
var TreatmentEffectVisViolin = function TreatmentEffectVisViolin(_ref) {
  ...
  var ref = (0, _react.useRef)('svgTreatmentEffect'); // let svg = d3.select(`#svgTreatmentEffect${index}`);
  ...
  (0, _react.useEffect)(function () {
    ...
    if (isBinary) {
      ...
      var newControlBins = [histogram(controlStratify0), histogram(controlStratify1)];
    ...
    if (isBinary) {
      ...
      (function () {
        ...
        var _loop = function _loop(i) {
          ...
          for (var _iterator2 = _createForOfIteratorHelperLoose(binData), _step2; !(_step2 = _iterator2()).done;) {
            var g = _step2.value;
          ...
          var binStats = getIQR(binEffects); // console.log(binStats);
