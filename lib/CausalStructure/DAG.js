...
var _DAGEditor = require("./DAGEditor");

var _DownloadDialog = require("./DownloadDialog");

var _TagDialog = require("./TagDialog");

var _NodeDialog = require("./NodeDialog");
...
var DAG = function DAG(_ref) {
  ...
  var _React$useState16 = _react["default"].useState(new Set()),
  ...
  function downloadSVG() {
    // console.log('saving...');
    var svgElement = (0, _d3Selection.select)("#svgDAG");
